...
const Home: NextPage = () => {
  ...
  return (
    <div className="bg-[#110416] min-h-screen flex flex-col">
      <Head>
        <title>HYPEBUCKS LOTTERY DRAW</title>
      </Head>
      ...
      <div className='flex-1'>
        ...
        <Marquee className='bg-[#5d3171ab] p-5 mb-5' gradient={false} speed={100}>
        ...
        {winnings > 0 && (
          <div onClick={onWithdrawWinnings} className='max-w-md md:max-w-2xl lg:max-w-4xl mx-auto mt-5'>
            <button className='p-5 bg-gradient-to-b from-pink-500 to-purple-600 animate-pulse text-center rounded-xl w-full'>
        ...
        <div className='stats-container space-y-2'>
          <div className="stats-container">
            ...
            <div className='flex text-white items-center space-x-2 bg-[#110416] border-[#5d3171] border p-4'>
              <p>TICKETS</p>
            ...
            <button
              ...
              onClick={handleClick}
              className='mt-5 w-full bg-gradient-to-br from-pink-500 to-purple-600 px-10 py-5 
      ...
      <footer className='border-t border-emerald-500/20 flex items-center text-white justify-between p-5'>
        <img
          ...
          src='https://hypebucks.io/wp-content/uploads/2023/05/cropped-1111-192x192.png'
          alt='logo'
        />

        <p className='text-xs text-emerald-900 pl-5'>
          DISCLAIMER: The website is published by HypeBucks, the operator of Lottery Draw.
